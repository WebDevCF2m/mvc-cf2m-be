    ...
    <div class="row">
        <div class="col-lg-8">
                ...
                <header class="mb-4">
                    ...
                    <p class="fs-5 mb-4">Site d'exemple procédural <a href="https://mvc.cf2m.be/" target="_blank">CF2m</a> utilisant des morceaux d'articles libres depuis <a href="https://fr.wikipedia.org/wiki/Wikip%C3%A9dia:Accueil_principal" target="_blank">Wikipédia</a>. Les spécifications techniques sont : MVC avec un dossier publique, PHP 8 procédural et MariaDB.</p>
